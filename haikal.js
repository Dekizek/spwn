...
// Base ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 Hw Mods : Copyan Dari Base Dika

› Create By ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫
› Base Ori ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫
› Copyan Base Dika Hisoka Morou

🌷 KALAU MAU RENAME TARO CREDITS GUA : ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 */
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC ©  𠄘 𝑻??𝒆 𝒁𝒆𝒌𝒚𝒂 𠁎 🔥°͢`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://www.youtube.com/@ZekyaZek`}}}, { quoted: m })} 
//=================================================//
try {
...
let teks = `${q}`
{
haikal.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫`,"body": `Selamat ${salam} kak ${pushname}`,
...
touchmebre = [
{
title: `🌷 zek🔥 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(m.chat, `🌷 zek🔥 🌷`, haikal.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🌷`, touchmebre, m)
break
...
var pollCreation = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"pollCreationMessage": {
"name": "HALO 👋 SAYA BOT ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫",
"options": [
{
...
{
"optionName": "SALAM BROTHER BY ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫"
}
],
...
"amount1000": "100",
"extendedTextMessage": {
"text": `MY DEVELOPER ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫`,
}
}}), { userJid: m.chat, quoted: doc})
...
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ${iphone}` }, { quoted: doc })
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ${iphone1}` }, { quoted: doc })
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ${iphone2}` }, { quoted: doc })
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ${iphone3}` }, { quoted: doc })
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ${iphone4}` }, { quoted: doc })
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ${iphone5}` }, { quoted: doc })
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ${iphone6}` }, { quoted: doc })
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ${buttonkal}` }, { quoted: doc })
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ${buttonvirus}` }, { quoted: doc })
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ${ngazap(prefix)}`}, { quoted: doc })
}
}
break
//=================================================//
...
"mimetype": "image/jpeg",
"caption": `© ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫${ngazap(prefix)}`,
...
"fileName": `© ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫${ngazap(prefix)}`,
...
"title": `© ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫${ngazap(prefix)}`,
"previewType": "NONE",
}
}), { userJid: m.chat, quoted: doc })
...
"description": "Developer ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫\nWhatsApp / Script Bot \n\nORDER ? CHAT AJA 👋",
"title": `© ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫${ngazap(prefix)}`,
"previewType": "NONE",
"jpegThumbnail": messa.imageMessage,
}
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫${ngazap(prefix)}`,
"groupName": `MY NAME ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫${ngazap(prefix)}`,
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫${ngazap(prefix)}`,
...
"title": `© ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫${ngazap(prefix)}`,
"description": `© ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫`,
"currencyCode": "IDR",
"footerText": `© ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫`,
"priceAmount1000": "10000000",
"productImageCount": 1,
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 WE ARE NOT MASTOD`,
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ${ngazap(prefix)}.BIN`, title: `©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ${ngazap(prefix)}.BIN` }, { quoted: doc })
}
}
break
//=================================================//
...
ydd = `Yooo...Iam zek🔥`
for (let i = 0; i < jumlah; i++) {
 const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `© ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫\nitem1.TEL:+6285788734756\nitem1.X-ABLabel:Celular\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;\nEND:VCARD` }}}
...
haikal.sendMessage(m.chat, anuala, `©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
caption: `© ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ${buttonkal}`,
} 
...
case 'sc': {
if (isBan) throw sticBanLu(from)
reply('Script Recode By 𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 𝐊𝐞𝐜𝐞 𝐁𝐚𝐝𝐚𝐢 / wa.me/+6285831491081')
}
break
//=================================================//
case 'chat': {
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫, 7, 7, 2005, Putri, 16, 11, 2004`
...
case 'artinama': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 Gans`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫, 7, 7, 2005`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫|Putri`
...
case 'fengshui': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} ©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
gifPlayback:true,
jpegThumbnail:log0,
caption: `◎ © Hay ${pushname} 👋 Selamat ${salam}

[ Aku Adalah Bot Pribadi 𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ]
...
case 'menu': {
if (isBan) throw sticBanLu(from)
haikal.sendMessage(m.chat, { image: kalimage, caption: ` Yooo...Bagaimana Kabar Mu ${pushname} Dan Selamat ${salam}

Aku Adalah Bot 𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 
...
┗━━⊱
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
©  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫`, contextInfo:{"externalAdReply": {"title": `SC 𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://www.youtube.com/@ZekyaZek`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
case 'bugmenu': {
if (isBan) throw sticBanLu(from)
haikal.sendMessage(m.chat, { image: kalimage, caption: ` Yoo...Bagaimana Kabar Mu ${pushname} Dan Selamat ${salam}, Fitur Ini Hanya Khusus Owner Doang Ngab
...
┗━━⊱[ 𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫 ]`,
contextInfo:{"externalAdReply": {"title": `SC  𝑫𝒂𝒓𝒌 𝑿𝒆𝒚𝒛𝒊𝒙 𠗫`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://www.youtube.com/@ZekyaZek`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
